...
writeRaster(drought_char_all[[1]], paste0(path2, loc, "_all_drought_-1.tif"), format="GTiff", overwrite=T)
writeRaster(drought_char_all[[2]], paste0(path2, loc, "_all_drought_-1.5.tif"), format="GTiff", overwrite=T)
writeRaster(drought_char_all[[3]], paste0(path2, loc, "_all_drought_-2.tif"), format="GTiff", overwrite=T)
